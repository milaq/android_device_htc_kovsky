...
char const*const LCD_AUTO_FILE = "/sys/module/leds_microp_htckovsky/parameters/auto_brightness";
...
static void set_speaker_light_locked (struct light_device_t *dev, struct light_state_t *state) {
	...
	LOGV("%s - colors: R=%i, G=%i, B=%i", __func__, red, green, blue);
...
const struct hw_module_t HAL_MODULE_INFO_SYM = {
	...
	.name = "Kovsky lights module",
	.author = "Diogo Ferreira <diogo@underdev.org>, Micha LaQua <micha.laqua@gmail.com>",
